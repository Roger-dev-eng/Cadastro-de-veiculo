...
while True:
  ...
  while True:
    ...
    combustivel=str(input('Tipo de combustível:')).lower()
  ...
  while True:
    ...
    cambio=str(input('Tipo de câmbio: ')).lower()
  ...
  print(tabela)
  end=int(input('Quer adicionar mais um veículo? Digite 1 para não ou digite qualquer outro número para continuar:'))
  if end == 1:
    break
